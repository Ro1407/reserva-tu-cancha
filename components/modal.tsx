...
export function Modal({ children, modalTitle, onModalClose }: ModalProps) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-60 backdrop-blur">
      ...
      <div className="relative z-10 w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg shadow-xl m-4 bg-gray-100 dark:bg-gray-800">
        <div className="sticky top-0 flex justify-end p-4 bg-gray-100 dark:bg-gray-800 border-b">
