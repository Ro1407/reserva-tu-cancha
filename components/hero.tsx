...
export function Hero() {
  return (
    <section className="z-30 relative bg-gradient-to-br from-green-50 via-white to-blue-50 py-20 md:py-32 dark:from-green-950/20 dark:via-gray-950 dark:to-blue-950/20">
