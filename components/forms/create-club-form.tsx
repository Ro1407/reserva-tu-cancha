              ...
              {submitStatus != "idle" && (
                <div role="status" aria-live="polite" className="space-y-4">
                  {submitStatus == "success" ? (
                    <FormMessage type={FormMessageType.success}>El club fue creado exitosamente</FormMessage>
                  ) : (
                    <FormMessage type={FormMessageType.error}>
                      Ocurrió un error creando el club, por favor intente nuevamente
                    </FormMessage>
                  )}
                </div>
              )}
