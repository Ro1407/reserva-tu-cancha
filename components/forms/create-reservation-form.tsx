...
export default function CreateReservationForm() {
  ...
  const {
    ...
    useForm({
      ...
      defaultValues: emptyReservation,
      mode: "onBlur"
    });
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="text-center space-y-1">
            <CardTitle className="text-2xl font-bold">Crear Nueva Reserva</CardTitle>
            <CardTitle className="text-xl font-thin">
              Completa los campos para crear una nueva reserva.
            </CardTitle>
          </div>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <Select onValueChange={field.onChange}>
                      ...
                      >
                        <SelectValue placeholder="Seleccionar usuario"
                                     convertSelectedValue={getUserNameById}></SelectValue>
                      </SelectTrigger>
                      <SelectContent>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button type="submit" className="flex-1" disabled={isLoading} title="Crear reserva(Enter)">
                {isLoading ? (
                  <>
